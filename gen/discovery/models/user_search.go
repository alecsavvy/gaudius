...
func (m *UserSearch) validateData(formats strfmt.Registry) error {
...
// ContextValidate validate this user search based on the context it is used
...
func (m *UserSearch) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
