...
//
// swagger:model transaction_history_response
...
func (m *TransactionHistoryResponse) Data() []TransactionDetails {
	return m.dataField
}

// SetData sets the data of this base type
func (m *TransactionHistoryResponse) SetData(val []TransactionDetails) {
	m.dataField = val
}

// UnmarshalJSON unmarshals this object with a polymorphic type from a JSON structure
func (m *TransactionHistoryResponse) UnmarshalJSON(raw []byte) error {
	var data struct {
	...
	var propData []TransactionDetails
	if string(data.Data) != "null" {
		data, err := UnmarshalTransactionDetailsSlice(bytes.NewBuffer(data.Data), runtime.JSONConsumer())
...
func (m TransactionHistoryResponse) MarshalJSON() ([]byte, error) {
	var b1, b2, b3 []byte
	var err error
...
func (m *TransactionHistoryResponse) validateData(formats strfmt.Registry) error {
...
func (m *TransactionHistoryResponse) validateLatestChainBlock(formats strfmt.Registry) error {
...
func (m *TransactionHistoryResponse) validateLatestChainSlotPlays(formats strfmt.Registry) error {
...
func (m *TransactionHistoryResponse) validateLatestIndexedBlock(formats strfmt.Registry) error {
...
func (m *TransactionHistoryResponse) validateLatestIndexedSlotPlays(formats strfmt.Registry) error {
...
func (m *TransactionHistoryResponse) validateSignature(formats strfmt.Registry) error {
...
func (m *TransactionHistoryResponse) validateTimestamp(formats strfmt.Registry) error {
...
func (m *TransactionHistoryResponse) validateVersion(formats strfmt.Registry) error {
...
func (m *TransactionHistoryResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TransactionHistoryResponse) contextValidateVersion(ctx context.Context, formats strfmt.Registry) error {
